...
const PhoneIcon = ({ size = 18 }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} aria-hidden="true">
    <path fill="currentColor" d="M21.7 16.9c.3.2.3.6.3.9v3a2 2 0 0 1-2 2A18 18 0 0 1 3.2 6a2 2 0 0 1 2-2h3c.3 0 .7 0 .9.3l2.1 2.1c.3.3.4.8.2 1.2l-1.3 3c1.7 3 3.9 5.2 6.9 6.9l3-1.3c.4-.2.9-.1 1.2.2l2.1 2.1Z"/>
  </svg>
);

const MailIcon = ({ size = 18 }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} aria-hidden="true">
    <path fill="currentColor" d="M20 4H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h16a2 2 0 0 0 2-2V6c0-1.1-.9-2-2-2Zm0 3.2-8 5-8-5V6l8 5 8-5v1.2Z"/>
  </svg>
);
...
const SOCIALS = [
  {
    name: "Twitter",
    href: "https://twitter.com/smartgreengroup",
    icon: (
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
        <path fill="currentColor" d="M13.5 22v-8h2.7l.4-3h-3.1V9c0-.9.3-1.5 1.6-1.5H17V5.1c-.3 0-1.2-.1-2.3-.1-2.3 0-3.8 1.4-3.8 3.9v2.1H8v3h2.9v8h2.6z"/>
      </svg>
    )
  },
  {
  ...
  return (
    <div className="top-ribbon">
      <div className="container inner">
        <div className="left">
          <a className="mini-link" href="tel:+37368965566" aria-label="Telefon">
            <PhoneIcon /> +373 68965566
          </a>
          <span className="mini-sep" />
          <a className="mini-link" href="mailto:office@smartgreengroup.md" aria-label="Email">
            <MailIcon /> office@smartgreengroup.md
          </a>
        </div>
        ...
        <ul className="socials">
          {SOCIALS.map(s => (
            <li key={s.name}>
              <a href={s.href} aria-label={s.name} title={s.name} target="_blank" rel="noreferrer">
                {s.icon}
              </a>
            </li>
          ))}
